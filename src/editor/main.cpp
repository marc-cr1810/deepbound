...
int main(int argc, char *argv[]) {
  ...
  std::cout << "Loaded " << tile_registry.get_all_tiles().size() << " tiles."
            << std::endl;
  std::cout << "Loaded " << item_registry.get_all_items().size() << " items."
            << std::endl;
  std::cout << "Loaded " << entity_registry.get_all_entities().size()
            << " entities." << std::endl;
  std::cout << "Loaded " << strata_registry.get_all_strata().size()
            << " strata." << std::endl;
  std::cout << "Loaded " << landform_registry.get_all_landforms().size()
            << " landforms." << std::endl;
